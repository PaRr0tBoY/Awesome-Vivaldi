    ...
    nq: () => ke,
        ...
        const q = (0, F.Z)(() => {
            const e = new Date();
            let t = // m.Z = Preferences
    m.Z.get(H.kStartupActiveDays) || [];
          ...
          J = (0, F.Z)((e) => {
            const { toStart: t, windowId: n } = e,
              i = // u.ZP = TilingController
    u.ZP.getActivePage(n);
            if (!i) return;
            const s = // u.ZP = TilingController
    u.ZP.getSelectionOrActivePage(n),
              a = (0, // O.av = Page to Tab converter
    O.av)(i),
              o = // u.ZP = TilingController
    u.ZP.getPages(n);
            if (a) {
              const e = o.flatMap((e, t) => ((0, // O.av = Page to Tab converter
    O.av)(e) === a ? [t] : [])),
                r = s.filter((e) => (0, // O.av = Page to Tab converter
    O.av)(e) === a),
        ...
        async function ee(e, t = "", n = {}) {
          ...
          const i = (0, M.getUrl)(t),
            s = i && "_blank" !== i ? i : // u.ZP = TilingController
    u.ZP.getDefaultStartpage(e);
          ...
          if (
            ...
            const t = // u.ZP = TilingController
    u.ZP.getPages(e).find((e) =>
    ...
    l.Z.dispatch({
          ...
          n.tiling && (c.tiling = n.tiling),
            n.groupId &&
              ...
              (r.pinned = // u.ZP = TilingController
    u.ZP.isPinnedGroup(n.groupId, e)));
    ...
    u.ZP.getPages(a, {
            ...
            if ((a !== s && (await w.Z.focus(s)), n !== o)) {
              const t = // u.ZP = TilingController
    u.ZP.getPageInWindow(s, e);
              t?.vivExtData.tiling && (await i.nI(s, // D.aV = Tab/Page conversion
    D.aV.of(t))),
                await Pe(s, n);
            }
            Se(e, s);
    ...
    l.Z.dispatch({
        ...
        async function oe(e, t) {
          ...
          const n = // u.ZP = TilingController
    u.ZP.getPageInWindow(e, t),
            i = n ? (0, O.cm)(n) : void 0;
    ...
    l.Z.dispatch(n);
        ...
        function le(e, t) {
          ...
          if (n) {
            ...
            return void // l.Z = Redux dispatcher
    l.Z.dispatch(i);
          }
          const i = {
    ...
    l.Z.dispatch(i);
        ...
        function de() {
          return "off" !== // m.Z = Preferences
    m.Z.get(H.kTabsStackingMode);
        }

        function ue(e) {
          if (h.Z.offerNewTab(e)) return;
          const t = // s.ZP = TabToPage converter
    s.ZP.tabToPage(e),
            { openerTabId: n, windowId: i } = t,
            a = // u.ZP = TilingController
    u.ZP.getActivePage(i),
            o = T.Z.getActiveWorkspaceId(i),
            r = {
              ext_id: (0, O._o)(t) || crypto.randomUUID(),
            },
            c = [...// u.ZP = TilingController
    u.ZP.getPageHistory(i)];
          ...
          if (!we && !t.pinned) {
            ...
            (!n || (n && o !== (0, O.cm)(t))) &&
              (t.index = (function (e, t, n) {
                const { windowId: i } = e,
                  s = // u.ZP = TilingController
    u.ZP.getPages(i),
                  a = n ? "alwayslast" : // m.Z = Preferences
    m.Z.get(H.kTabsNewPlacement),
                  o =
    ...
    u.ZP.getPageById(e.openerTabId)
                ...
                let r;
                switch (
                  ((r = n ? void 0 : o ? (0, // O.av = Page to Tab converter
    O.av)(o) : (0, // O.av = Page to Tab converter
    O.av)(e)), a)
                ) {
                  case "openintabstackwithrelated":
                  case "rightofcurrent": {
                    if ("number" != typeof e.openerTabId)
                      return r && // u.ZP = TilingController
    u.ZP.isGroup(r, i)
                        ? // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup(r, i).last().index + 1
                        : e.index;
                    if (o?.pinned) return // u.ZP = TilingController
    u.ZP.getPinnedCount(o.windowId);
                    const t = (t) =>
                        t.id !== e.openerTabId &&
    ...
    u.ZP.getGroup(r, i).last().index + 1;
                ...
                if (!t) return e.index;
                const l = (0, // O.av = Page to Tab converter
    O.av)(t);
                if (r && r !== l && // u.ZP = TilingController
    u.ZP.isGroup(l, t.windowId))
                  return // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup(l, t.windowId).last().index + 1;
                return t.pinned ? // u.ZP = TilingController
    u.ZP.getPinnedCount(t.windowId) : t.index + 1;
              })(t, a, n));
          }
          let p,
            g = t.pinned;
    ...
    u.ZP.getPageById(n);
            if (t) {
              const s =
                "openintabstackwithrelated" === // m.Z = Preferences
    m.Z.get(H.kTabsNewPlacement) &&
                !(0, M.isInternalUrl)(t.url) &&
                !t.pinned;
              if (s || // m.Z = Preferences
    m.Z.get(H.kTabsStackingOpenInCurrent)) {
                let a = (0, // O.av = Page to Tab converter
    O.av)(t);
                if ((!a && s && ((a = // u.ZP = TilingController
    u.ZP.getNewGroupId()), (p = n)), a)) {
                  g = // u.ZP = TilingController
    u.ZP.isPinnedGroup(a, i);
                  if (s || // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup(a, t.windowId).size > 1) {
                    (r.group = a),
                    ...
                    if (o && !s && !e.vivExtData?.includes("tiling")) {
                      const e = // u.ZP = TilingController
    u.ZP.getTiles(i, o.id);
                      r.tiling = {
                        ...o,
                        index: e.size,
                      };
          ...
          if (f.ZP.getIsLoading()) {
            ...
            if (f.ZP.getLoadPersistentTabs())
              ...
              let e = // m.Z = Preferences
    m.Z.get(H.kWorkspacesEnabled) ? (0, O.cm)(t) : void 0;
              if (void 0 !== e) {
    ...
    _.Z.tabs.move([t.id], {
        ...
        function he(e) {
          ...
          if (S.Z.findPanelByTabId(e.tabId)) {
            const n = // u.ZP = TilingController
    u.ZP.getPageHistory(t);
            if (n.length > 1) {
              const i = n[n.length - 1],
                s = // u.ZP = TilingController
    u.ZP.getPageInWindow(t, i);
              s && (e.tabId = s.id);
            }
          }
          // l.Z = Redux dispatcher
    l.Z.dispatch({
        ...
        function pe(e, t, n) {
          ...
          const a = [...// u.ZP = TilingController
    u.ZP.getPageHistory(s)];
    ...
    l.Z.dispatch({
              ...
              deactivatePageId: i.active ? // u.ZP = TilingController
    u.ZP.getActivePage(s)?.id : void 0,
              windowId: s,
            });
        }
    ...
    l.Z.dispatch({
            ...
            n ||
              ((xe = (0, R.M)()),
              void 0 !== // u.ZP = TilingController
    u.ZP.replacementTab?.id &&
                (await _.Z.tabs.remove(// u.ZP = TilingController
    u.ZP.replacementTab.id),
                (// u.ZP = TilingController
    u.ZP.replacementTab = void 0)));
        }
        async function be() {
          const e = // m.Z = Preferences
    m.Z.get(H.kTabsStackingNameMap) || {};
          if (Object.keys(e).length) {
            (await _.Z.tabs.query({})).forEach(async (t) => {
              const n = // s.ZP = TabToPage converter
    s.ZP.tabToPage(t);
        ...
        async function ye(e, t, n) {
          const i = n ? n.substring(0, 50) : void 0,
            s = // u.ZP = TilingController
    u.ZP.getPages(e).filter((e) => (0, // O.av = Page to Tab converter
    O.av)(e) === t);
          await Promise.all(
            s.map(({ id: e }) =>
              (0, $.V)(e, {
    ...
    l.Z.dispatch({
        ...
        async function Ae(e, t) {
          const n = e.first().windowId,
            i = e.map((e) => e.id),
            s = new Set(e.map(// O.av = Page to Tab converter
    O.av).filter(Boolean)),
    ...
    u.ZP.getPageByReloadId(
            ...
            await Promise.all(
              s.values().map((e) => {
                const t = // u.ZP = TilingController
    u.ZP.getPages(n).filter(
                  (t) => (0, // O.av = Page to Tab converter
    O.av)(t) === e && !i.includes(t.id)
                );
                if (1 === t.size)
    ...
    u.ZP.getTiles(e, t);
        ...
        async function Te(e, t) {
          const { bypassConfirm: n = !1, forceClosePinned: i = !1 } = t ?? {},
            s = ke(e) ? e : // D.aV = Tab/Page conversion
    D.aV.of(e);
          if (0 === s.size) return;
          const a = i ? "on" : // m.Z = Preferences
    m.Z.get(H.kTabsClosePinned),
            o = s.first().windowId,
            c = (function (e, t, n) {
              const i = // u.ZP = TilingController
    u.ZP.getPages(t);
              if (1 === i.size && !// u.ZP = TilingController
    u.ZP.canClosePage(i.first()))
                return (0, // D.aV = Tab/Page conversion
    D.aV)([]);
              let s = e;
              if ("off" === n || "bury" === n) {
                const t = // m.Z = Preferences
    m.Z.get(H.kTabsClosePinnedInStack);
                s = e.filter((e) => !e.pinned || ((0, // O.av = Page to Tab converter
    O.av)(e) && t));
              }
              return s;
            })(s, o, a);
    ...
    m.Z.get(H.kTabsConfirmClosingTabs) &&
            c.size >= // m.Z = Preferences
    m.Z.get(H.kTabsConfirmClosingThreshold)
          )
    ...
    u.ZP.getPages(o, {
              ...
              ((h = void 0 === e && !// m.Z = Preferences
    m.Z.get(H.kTabsNeverCloseLast)),
              (d = void 0 !== e && !// m.Z = Preferences
    m.Z.get(H.kTabsNeverCloseLast)),
              // m.Z = Preferences
    m.Z.get(H.kTabsNeverCloseLast) && !// u.ZP = TilingController
    u.ZP.replacementTab)
            ) {
              x.ZP.isPopulatingEmptyWorkspace = !0;
              const t = await _.Z.tabs.create({
                url: // u.ZP = TilingController
    u.ZP.getDefaultStartpage(o),
                active: !1,
              ...
              (x.ZP.isPopulatingEmptyWorkspace = !1), (// u.ZP = TilingController
    u.ZP.replacementTab = t);
            }
          }
          const p = c.map((e) => e.id).toArray(),
            g = // u.ZP = TilingController
    u.ZP.replacementTab ? void 0 : ne(s);
          g && Be.activateTab(g, o), await Ae(s, !0), await _.Z.tabs.remove(p);
          const f = // u.ZP = TilingController
    u.ZP.replacementTab?.id;
          // u.ZP = TilingController
    u.ZP.replacementTab = void 0;
          const v = s.get(0);
    ...
    u.ZP.addListener(o, (t) => t.get(e.windowId));
                ...
                function a() {
                  s || (n(), (s = !0), // u.ZP = TilingController
    u.ZP.removeListener(o), clearTimeout(i));
                }
    ...
    u.ZP.getPageInWindow(e.windowId, e.id) || a();
            ...
            void 0 !== f
              ...
              : g && // u.ZP = TilingController
    u.ZP.getActivePage(o)?.id !== g && Be.activateTab(g, o),
            d && Pe(o, void 0),
            h && (await // w.Z = WindowManager.close
    w.Z.close(o));
        }
        ...
        function _e(e, t) {
          const { windowId: n } = e,
            ...
            s = (0, // O.av = Page to Tab converter
    O.av)(e);
          let a = // u.ZP = TilingController
    u.ZP.getPages(n).filter(
          ...
          return (
            (a = t
              ? a
                  .skipUntil((e) => (0, // O.av = Page to Tab converter
    O.av)(e) === s)
                  .takeUntil((t) => t.id === e.id)
              : // u.ZP = TilingController
    u.ZP.isGroup((0, // O.av = Page to Tab converter
    O.av)(e), e.windowId)
              ? a
                  .takeUntil((t) => t.id === e.id)
                  .filter((e) => (0, // O.av = Page to Tab converter
    O.av)(e) !== s)
    ...
    u.ZP.getPages(n, {
          ...
          return (
            t
              ? (a = a.takeUntil((e) => (0, // O.av = Page to Tab converter
    O.av)(e) !== s))
              : // u.ZP = TilingController
    u.ZP.isGroup((0, // O.av = Page to Tab converter
    O.av)(e), e.windowId) &&
                (a = a.filter((e) => (0, // O.av = Page to Tab converter
    O.av)(e) !== s)),
            a
          );
        }
    ...
    u.ZP.getActivePage(e);
            if (!t) return;
            s = // u.ZP = TilingController
    u.ZP.getPages(e).filter((e) => e.id !== t.id);
          } else if ("all" === t) s = // u.ZP = TilingController
    u.ZP.getPages(e);
    ...
    D.aV.of(t);
        ...
        function ke(e) {
          return e instanceof // D.aV = Tab/Page conversion
    D.aV;
        }
    ...
    _.Z.tabs.move(i.id, {
        ...
        async function Ne(e, t, n) {
          ...
          e.some((e) => e.active) &&
            ...
            ee(s);
          const a = await // Move tab
    _.Z.tabs.move(e.map((e) => e.id).toArray(), {
            windowId: t,
            index: -1,
          });
        ...
        async function Pe(e, t) {
          for (const [n] of // u.ZP = TilingController
    u.ZP.getState())
    ...
    u.ZP.getDefaultStartpage(e),
        ...
        async function Me(e, t, n = !1) {
          const i = ke(e) ? e : // D.aV = Tab/Page conversion
    D.aV.of(e),
            s = i.first().windowId,
            a = T.Z.getActiveWorkspaceId(s);
          let o = s;
          const r = i
            .groupBy(// O.av = Page to Tab converter
    O.av)
            .map((e, t) =>
              void 0 === t || // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup(t, s).size === e.size
                ? (0, // D.aV = Tab/Page conversion
    D.aV)()
                : e
            )
            .flatten()
          ...
          if (
            (await Oe(r),
            t && ((o = // u.ZP = TilingController
    u.ZP.getWorkspaceWindowId(t) ?? s), o !== s))
          )
    ...
    u.ZP.getPages(s, {
        ...
        async function De(e, t = {}) {
          ...
          const r = e.find(// O.av = Page to Tab converter
    O.av),
            c = r ? (0, // O.av = Page to Tab converter
    O.av)(r) : "",
            d = i || c || // u.ZP = TilingController
    u.ZP.getNewGroupId(),
    ...
    l.Z.dispatch({
        ...
        async function Oe(e) {
          const t = ke(e) ? e : // D.aV = Tab/Page conversion
    D.aV.of(e);
          if (t.isEmpty()) return;
    ...
    l.Z.dispatch({
            ...
            await Ae(t, !1);
          const i = // u.ZP = TilingController
    u.ZP.getPages(n).last().index + 1;
          await Be.moveToIndex(n, t, i);
        }

        function Le(e, t = (0, // D.aV = Tab/Page conversion
    D.aV)()) {
          const n = function (n) {
        ...
        async function // je = unpinTabStack helper
    je(e, t, n) {
            ...
            clonePages: async function (e) {
              ...
              try {
                const n = e
                  ...
                  .filter((e) => !(0, // M = SingletonPage checker
    M.isSingletonPage)(e));
                let i = -1;
                for (const e of n) {
                  i++;
                  const n = e.index,
                    a = await // _.Z.tabs = Chrome Tabs API
    _.Z.tabs.duplicate(e.id);
                  if (!a) continue;
                  const o = a.id;
                  if (!o) continue;
                  "alwayslast" === // m.Z = Preferences
    m.Z.get(// H.kTabsActivationOnClone = preference key
    H.kTabsActivationOnClone)
                    ? await // Move tab
    _.Z.tabs.move(o, {
                        index: -1,
                      })
    ...
    _.Z.tabs.move(o, {
                  ...
                  const r = (0, // O.av = Page to Tab converter
    O.av)(e);
                  if (r && // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup(r, e.windowId).size > 1) {
                    const t = // s.ZP = TabToPage converter
    s.ZP.tabToPage(a);
                    await De((0, // D.aV = Tab/Page conversion
    D.aV)([e, t]));
                  }
                  t.push(o);
                }
            ...
            close: async function (e) {
              const t = await // xe = waitForTransition helper
    xe();
              try {
                if (// x.ZP = Browser checker
    x.ZP.isTabbedBrowser(e)) {
                  const t = // u.ZP = TilingController
    u.ZP.getSelectionOrActivePage(e);
                  await // closePage method
    Be.closePage(t);
                } else await // w.Z = WindowManager.close
    w.Z.close(e);
              } finally {
                t();
              }
    ...
    O.av)(e), e.windowId)
                    ? // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup((0, // O.av = Page to Tab converter
    O.av)(e), e.windowId)
                    : // D.aV = Tab/Page conversion
    D.aV.of(e)
                  ).map((e) => e.id)
                );
                a = // u.ZP = TilingController
    u.ZP.getPages(s, {
                ...
                const e = i.map(// O.av = Page to Tab converter
    O.av).toSet();
                a =
    ...
    u.ZP.getPages(s, {
                        ...
                        .filter((t) => (0, // O.av = Page to Tab converter
    O.av)(t) === e.first())
    ...
    u.ZP.getPageById(e);
              if (!t) return;
              const n = (0, // O.av = Page to Tab converter
    O.av)(t);
              Te(// u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup(n, t.windowId));
            },
            ...
            closeUrl: function (e, t) {
              Te(// u.ZP = TilingController
    u.ZP.getPages(e).filter((e) => (0, U.uu)(t, e.url)));
            },
            closeDuplicateTabs: function (e) {
              const t = x.ZP.getActiveWindowId(),
                n = Array.isArray(e) ? e : [e];
              let i = (0, // D.aV = Tab/Page conversion
    D.aV)();
              for (const e of n) {
                let n = (0, // D.aV = Tab/Page conversion
    D.aV)();
                for (const [i, s] of // u.ZP = TilingController
    u.ZP.getState()) {
                  const a = new Map(
                      s.list
                        .filter((t) => t.url === e)
    ...
    u.ZP.getPages(e, {
            ...
            createStackFromActiveTab: async function (e) {
              if (!de()) return;
              const t = // u.ZP = TilingController
    u.ZP.getSelectedPages(e);
              if (t.size > 1) return Be.createTabStack(t);
              const n = T.Z.getActiveWorkspaceId(e),
                i = // u.ZP = TilingController
    u.ZP.getPages(e, {
                  workspaceId: n,
                }).filter((e) => !e.pinned && !(0, // O.av = Page to Tab converter
    O.av)(e));
              if (i.size > 1) {
                const [t, s] = (0, W.d)(
                  // u.ZP = TilingController
    ...
    u.ZP.getNewGroupId();
            ...
            createGroupByHost: async function (e, t, n) {
              const i = // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroupsForHosts(e, t).get(n);
              if (i) {
                const t = // u.ZP = TilingController
    u.ZP.getNewGroupId();
                return (
    ...
    l.Z.dispatch({
            ...
            cycleByOrder: function (e, t, n = !1) {
              const i = T.Z.getActiveWorkspaceId(e),
                s = // u.ZP = TilingController
    u.ZP.getCyclePageByOrder(e, i, n);
              s && Se(s, e);
            },
    ...
    D.aV.of(e),
            ...
            detachWorkspace: async function (e, t) {
              const n = // u.ZP = TilingController
    u.ZP.getWorkspacePages(t).first(),
    ...
    je(
            ...
            moveSelectionToWorkspace: function (e, t) {
              ...
              Me(// u.ZP = TilingController
    u.ZP.getSelectionOrActivePage(e).filter(Boolean), n);
            },
    ...
    u.ZP.getPages(e).filter(
            ...
            pastePages: async function (e, t, n, i) {
              ...
              const s = n.sort((e, t) => e.index - t.index),
                ...
                o = (0, // O.av = Page to Tab converter
    O.av)(e),
                r = (0, O.cm)(e),
                l = // u.ZP = TilingController
    u.ZP.getPages(e.windowId).find(
                  (e) => (0, // O.av = Page to Tab converter
    O.av)(e) === o && Boolean(e.vivExtData.tiling)
                )?.vivExtData.tiling;
              if (i) {
    ...
    je(t, n, !0);
            ...
            newTab: async function (
              ...
              const i = n.index,
                ...
                a = n.groupId ?? void 0,
                o = (0, M.getUrl)(t),
                r = o && "_blank" !== o ? o : // u.ZP = TilingController
    u.ZP.getDefaultStartpage(e),
                c = {
                  url: r,
                  windowId: e,
                  ...
                  pinned: // u.ZP = TilingController
    u.ZP.isPinnedGroup(a, e),
                };
              // m.Z = Preferences
    ...
    l.Z.dispatch({
            ...
            openLastPage: function (e) {
              const t = T.Z.getActiveWorkspaceId(e),
                n = !de(),
                i = // u.ZP = TilingController
    u.ZP.getWorkspaceTabsInWindow(e, t, n).last();
              i && Se(i.page.id, e);
            },
            activateTab: Se,
            activateTabByIndex: function (e, t) {
              const n = T.Z.getActiveWorkspaceId(e),
                i = !de(),
                s = // u.ZP = TilingController
    u.ZP.getWorkspaceTabsInWindow(e, n, i).get(t);
              if (!s) return;
              const a = "group" === s.type ? s.pages : (0, // D.aV = Tab/Page conversion
    D.aV)();
    ...
    u.ZP.getDefaultStartpage(e),
            ...
            stepPage: async function (e, t, n, i) {
              const s = // u.ZP = TilingController
    u.ZP.getStepInfo(e, t, n, i);
              if (!s) return;
              const { pages: a, index: o } = s;
              await Be.moveDroppedTabs(i, a, e.id, o, (0, // O.av = Page to Tab converter
    O.av)(e));
            },
    ...
    u.ZP.getSelectionOrActivePage(e);
              if (!t.isEmpty())
                for (let e = 0; e < t.size; e += 1) {
                  const n = t.get(e);
                  if (!n) return;
                  const i = (0, // O.av = Page to Tab converter
    O.av)(n),
                    s = // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup(i, n.windowId),
            ...
            treeMove: async function ({
              ...
              const l = // u.ZP = TilingController
    // u.ZP = TilingController.getGroup
    u.ZP.getGroup(a, e).first(),
                c = l ? (0, O.XN)(l) : void 0,
                d = l ? (0, O.nI)(l) : void 0,
                h = new Map();
              await Promise.all(
                t.map(async (t) => {
                  const s = (0, // O.av = Page to Tab converter
    O.av)(t);
                  switch ((s && h.set(s, t.windowId), i)) {
                    ...
                    case "stack": {
                      const n = // u.ZP = TilingController
    u.ZP.getPages(e).find(
                        (e) =>
                          (0, // O.av = Page to Tab converter
    O.av)(e) === a && Boolean(e.vivExtData.tiling)
                      )?.vivExtData.tiling;
                      return (
                        await (0, $.V)(t.id, {
                          group: a,
                    ...
                    case "regular": {
                      const e = (0, // O.av = Page to Tab converter
    O.av)(t),
