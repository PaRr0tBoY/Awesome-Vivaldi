      ...
      48603: (e, t, n) => {
        ...
        function Q({ clipboardData: e }, t, n) {
          e &&
            ((t = // g.Z.validateForClipboard
    g.Z.validateForClipboard(t)),
            // Set vivaldi cut flag
    e.setData("vivaldi/x-cut", n),
            // Set rich text data
    e.setData(T.yR, JSON.stringify(t)),
            // Set plain text data
    e.setData("text/plain", // g.Z.bookmarksPrivate.getDragData
    g.Z.getDragData("text/plain", t)));
        }
        const q = new (class {
            loadPromise = () =>
              p
