...
| 文件                     | 描述                                             |
| :----------------------- | :----------------------------------------------- |
| `VividPeek.js`           | [Arc 预览对话框支持](../../Doc/mod/VividPeek.md) _（配合 `VividPeek.css`）_ |
| `AskOnPage.js`           | [用于页面问答、摘要和改写的 AI 侧边栏](../../Doc/mod/AskOnPage.md) |
| `AutoHidePanel.js`       | [自动隐藏侧边栏](../../Doc/mod/AutoHidePanel.md)                |
| `EasyFiles.js`           | [Opera 风格的文件附件，支持剪贴板和下载内容](../../Doc/mod/EasyFiles.md) |
| `ModConfig.js`           | [AI Key 和支持的修改项共用设置面板](../../Doc/mod/ModConfig.md)  |
| `MonochromeIcons.js`     | [网页面板图标单色化，减少视觉噪音](../../Doc/mod/MonochromeIcons.md) |
| `QuickCapture.js`        | [自动框选区域，支持剪贴板/文件/默认模式](../../Doc/mod/QuickCapture.md) |
| `TidyDownloads.js`       | [用 AI 清理下载文件名](../../Doc/mod/TidyDownloads.md)          |
| `TidyTabs.js`            | [AI 标签分组](../../Doc/mod/TidyTabs.md) _（配合 `TidyTabs.css`）_ |
| `TidyTitles.js`          | [AI 标签标题清理](../../Doc/mod/TidyTitles.md)                  |
| `TabManager.js`          | [Workspace Board 面板，用来查看和管理工作区标签](../../Doc/mod/TabManager.md) |
| `TidyAddress.js`         | [将地址栏可见后缀改写为 AI 生成的 slug](../../Doc/mod/TidyAddress.md) |
| `VividToast.js`          | [Toast 通知逻辑](../../Doc/mod/VividToast.md) _（配合 `VividToast.css`）_ |
